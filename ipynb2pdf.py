...
if not debugModeOn:
    ...
    argsVid = '".ipynb" file path required'


## Tests (clipboard_value examples)
# :-) Absolute file path of existing ".ipynb" file:
#argsVid = '/Users/anthony/MEGA/DOCUMENTS/Programmation/Python/MyPythonProjects/ConvertJupyterNotebookToPDF/tests/classifying_space_rocks.ipynb'
# :-) Absolute file path of existing ".ipynb" file:
#argsVid = project_path + '/tests/classifying_space_rocks.ipynb'
# :-) Absolute file path of nonexistent ".ipynb" file:
#argsVid = project_path + '/tests/tada.ipynb'
